{stdenv, buildOcaml, fetchurl, cmdliner, re, uri_p4, fieldslib_p4, sexplib_p4, conduit,
...
buildOcaml rec {
  ...
  propagatedBuildInputs = [ cmdliner re uri_p4 fieldslib_p4 sexplib_p4 sexplib_p4
